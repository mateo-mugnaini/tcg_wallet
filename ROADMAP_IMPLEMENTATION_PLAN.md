...
- Fase 1: en progreso. Ya existen los cinco endpoints de consulta graded prices con repository, service, controller, routes y schemas Zod; sync y fixture con datos reales siguen pendientes.
